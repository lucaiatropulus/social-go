        ...
        "/users/feed": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "How many items should be returned per page, at least 1, at most 20. Default is 20",
                        "name": "limit",
                        "in": "path"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Describes how the list should be sorted, ASC or DESC. Default is DESC",
                        "name": "sort",
                        "in": "path"
                    },
                    {
                        "type": "string",
                        "description": "Contains the search term. It searches both by title and content of the post",
                        "name": "search",
                        "in": "path"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filters the posts by the createdAt date and returns only the posts that were created after the given date",
                        "name": "since",
                        "in": "path"
                    },
                    {
                        "type": "string",
                        "description": "Filters the posts by the createdAt date and returns only the posts that were created until the given date",
                        "name": "until",
                        "in": "path"
                    }
                ],
